...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(organizationJsonLd).replace(/</g, "\\u003c") }}/><CartProvider>{children}<CookieConsent /></CartProvider></body>
    </html>
  );
}
