...
function fallback(product: NonNullable<Awaited<ReturnType<typeof getProduct>>>, message: string) {
  ...
  return product.chatbotKnowledge || `I can help with ${product.name}'s price, availability, delivery, returns and specifications. For anything not listed, email support@shoprenova.com.ng.`;
}
